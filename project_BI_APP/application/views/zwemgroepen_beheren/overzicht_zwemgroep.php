<div class="col-12 mb-2">
    <?php
        ...
        echo '<div class="row">
                ...
                <div class="col-8 text-right">' . anchor("Zwemgroepen/verwijderZwemgroep/" . $zwemgroep->id, "Verwijder", "class='btn btn-danger'") . ' '. anchor("Wachtlijsten/index",'Wachtlijst beheren', 'class="btn btn-primary"') . '</div>
              </div><hr>';
